...
urlpatterns = [
    ...
    path('<int:repository_id>/delete_branch/<int:branch_id>', views.edit_branch, name='edit_branch'),
    path('<int:repository_id>/edit_branch/<int:branch_id>', views.delete_branch, name='delete_branch'),
]
