...
urlpatterns = [
    ...
    path('<int:repository_id>/edit_issue/<int:issue_id>', views.add_issue, name='edit_issue'),
    path('<int:repository_id>/delete_issue/<int:issue_id>', views.add_issue, name='delete_issue'),
]
